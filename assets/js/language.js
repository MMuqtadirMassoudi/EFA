...
const setLanguage = (language) => {
    if (language == "pe"){
        ...
        programsNavLinkLabel.innerText = translations.pe.programsLinkPE;
        ...
        programsNavLinkLabel.innerText = translations.ps.programsLinkPS;
        ...
        programsNavLinkLabel.innerText = translations.en.programsLink;
